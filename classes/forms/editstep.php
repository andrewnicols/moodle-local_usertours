...
class editstep extends \moodleform {
     ...
     */
    public function __construct($target, \local_usertours\step $step) {
        $this->step = $step;
    ...
    public function definition() {
        ...
        $types = [];
        foreach (\local_usertours\target::get_target_types() as $value => $type) {
            $types[$value] = get_string('target_' . $type, 'local_usertours');
        }
        $mform->addElement('select', 'targettype', get_string('targettype', 'local_usertours'), $types);
